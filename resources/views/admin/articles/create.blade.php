        ...
        >@csrf
          ...
          <div class="mb-5">
            ...
            <textarea
              ...
              class="w-full rounded-md border border-[#e0e0e0] bg-black py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" rows="4" required>{{ old('short_text') }}</textarea>
          </div>
          ...
          <div class="mb-5 w-full bg-gray-50 rounded-lg border border-gray-200 dark:bg-gray-700 dark:border-gray-600">
            ...
            <div class="py-2 px-4 bg-white rounded-b-lg dark:bg-gray-800">
                ...
                <textarea id="editor" name="body" rows="8" class="block px-0 w-full text-sm text-gray-800 bg-white border-0 dark:bg-gray-800 focus:ring-0 dark:text-white dark:placeholder-gray-400" placeholder="Write an article..." required>{{ old('body') }}</textarea>
            </div>
          </div>
